...
def build_recommendation_prompt(issues: List[Dict[str, Any]]) -> str:
    ...
    return (
        ...
        "- For dates: NEVER guess or 'correct' invalid or ambiguous dates. If a date string does not represent a real\n"
        "  calendar date in a clear format (e.g. '1984-02-34', '1976-13-24', '01/16-03'), treat it as invalid and\n"
        "  map it to null instead of trying to infer the intended date.\n"
